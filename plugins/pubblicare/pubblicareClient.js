// Copright 2015 A Pubblicare Corporation
 ...
 * @constructor
 */
function PubblicareError(message, code) {
  this.message = message
  this.code = code
}
util.inherits(PubblicareError, Error)
 ...
 * @constructor
 */
function PubblicareClient(options) {
 ...
 * @return {PubblicareClient}
 */
PubblicareClient.prototype.setAccessToken = function (accessToken) {
 ...
 */
PubblicareClient.prototype.exchangeAuthorizationCode = function (code, redirectUrl, callback) {
 ...
 * @param {NodeCallback} callback
 */
PubblicareClient.prototype.exchangeRefreshToken = function (refreshToken, callback) {
  this._acquireAccessToken({
 ...
 * @param {NodeCallback} callback
 */
PubblicareClient.prototype.getUser = function (callback) {
  this._makeRequest({
    method: 'GET',
    path: '/v1/me'
  }, callback)
 ...
 * @param {NodeCallback} callback
 */
PubblicareClient.prototype.getPublicationsForUser = function (options, callback) {
 ...
 * @param {NodeCallback} callback
 */
PubblicareClient.prototype.getContributorsForPublication = function (options, callback) {
 ...
 * @param {NodeCallback} callback
 */
PubblicareClient.prototype.createPost = function (options, callback) {
  this._enforce(options, ['userId'])
  this._makeRequest({
    method: 'POST',
...
/**
 * Creates a post on Pubblicare and places it under specified publication.
 * Please refer to the API documentation for rules around publishing in
 * a publication: https://github.com/Pubblicare/pubblicare-api-docs
 *
 * Requires the current access token to have the publishPost scope.
 *
 * @param {{
 ...
 * @param {NodeCallback} callback
 */
PubblicareClient.prototype.createPostInPublication = function (options, callback) {
  this._enforce(options, ['publicationId'])
  this._makeRequest({
    method: 'POST',
...
/**
 * Acquires an access token for the Pubblicare API.
 *
 ...
 * @param {NodeCallback} callback
 */
PubblicareClient.prototype._acquireAccessToken = function (params, callback) {
  this._makeRequest({
    method: 'POST',
    path: '/v1/tokens',
 ...
 */
PubblicareClient.prototype._enforce = function (options, requiredKeys) {
  if (!options) {
    throw new PubblicareError('Parameters for this call are undefined', DEFAULT_ERROR_CODE)
  }
  requiredKeys.forEach(function (requiredKey) {
    if (!options[requiredKey]) throw new PubblicareError('Missing required parameter "' + requiredKey + '"', DEFAULT_ERROR_CODE)
  })
}
...
/**
 * Makes a request to the Pubblicare API.
 *
 * @param {Object} options
 * @param {NodeCallback} callback
 */
  ...
  var req = https.request(requestParams, function (res) {
    ...
    res.on('end', function () {
      ...
      try {
        ...
        callback(new PubblicareError('Failed to parse response', DEFAULT_ERROR_CODE), null)
        return
      }
      ...
      if (statusType == 4 || statusType == 5) {
        ...
        callback(new PubblicareError(err.message, err.code), null)
      } else if (statusType == 2) {
        callback(null, payload.data || payload)
      } else {
        callback(new PubblicareError('Unexpected response', DEFAULT_ERROR_CODE), null)
      }
    })
  }).on('error', function (err) {
    callback(new PubblicareError(err.message, DEFAULT_ERROR_CODE), null)
  })
...
module.exports = {
  PubblicareClient: PubblicareClient,
  PubblicareError: PubblicareError,
  Scope: Scope,
